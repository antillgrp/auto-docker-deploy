#!/bin/bash
#####################################################################################################
# Script_Name : xrdp-installer-1.5.1.sh
...
# Version : 1.5.1
# History : 1.5.1 - Add Support for Zorin OS (Best Effort)
...
/bin/echo -e "\e[1;36m   !   Written by Griffon - June    2024  -  www.c-nergy.be         !\e[0m"
/bin/echo -e "\e[1;36m   !                                                                 !\e[0m"
...
then 
    ...
    cnt=$(ls /usr/share/xsessions |  wc -l) ## && echo $cnt 
...
then
    ...
    grdctl --system rdp set-port 3390
    echo
...
sudo ./bootstrap
sudo ./configure --enable-fuse --enable-jpeg --enable-rfxcodec --enable-mp3lame --enable-vsock --enable-painter
sudo make
